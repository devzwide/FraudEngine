...
```bash
sqlpackage /Action:Publish /SourceFile:bin/Debug/FraudEngineDatabaseProject.dacpac /TargetServerName:localhost /TargetDatabaseName:FraudEngineDatabaseProject
```
